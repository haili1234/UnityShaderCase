...
[ExecuteInEditMode]
//添加选项到菜单中
[AddComponentMenu("BP/Post-Process Effect/3.PixelEffect")]
public class PixelEffect : MonoBehaviour
{
    ...
    [Tooltip("自动计算正方形像素所需的长宽比与否")] public bool AutoCalulateRatio = true;

    [Range(0f, 24f), Tooltip("此参数用于自定义长宽比")]
    public float Ratio = 1.0f;

    public string ShaderPath = "BP/Post-Process Effect/3.PixelEffect";
