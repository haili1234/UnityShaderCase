...
[ExecuteInEditMode]
//添加选项到菜单中
[AddComponentMenu("BP/Post-Process Effect/4.ScreenOilPaintEffect")]
public class ScreenOilPaintEffect : MonoBehaviour
{
    ...
    //两个参数值
    [Range(0, 5), Tooltip("分辨率比例值")] public float ResolutionValue = 0.9f;
    ...
    public string ShaderPath = "BP/Post-Process Effect/4.ScreenOilPaintEffect";
    ...
    void Start()
    {
        ...
        //找到当前的Shader文件
        CurShader = Shader.Find(ShaderPath);
